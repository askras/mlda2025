...
Мягкий дедлайн (100 баллов): 25.12.2026

Жесткий дедлайн (50 баллов): 25.12.2026

Работа не обязательна к выполнению
...
Предварительно необходимо скачать данные с [kaggle](https://www.kaggle.com/competitions/python-and-analyze-data-final-project)
...
Задание 3 (опционально). Выявить закономерности в поведении мужчин и женщин. 
